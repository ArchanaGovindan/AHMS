...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
              <div class="col-lg-12">
                  <h1 class="page-header">Maintenance to be done</h1>
              </div>
                    ...
                    $count=1;
                        $con = mysqli_connect('localhost', 'root', '', 'AHMS');
                         $query=mysqli_query($con,"select * from complaint");
                          ...
                          {
                					echo "<tr>";
                					echo "<td>".$count++."</td>"." "."<td>".$row['name']."</td>"." "."<td>".$row['roomno']."</td>"." "."<td>".$row['hostel']."</td>"." "."<td>".$row['complaint']."</td>"." ".
                          "<td><form action='maintain.php' method='post'><input type='hidden' name='h' value='".$row['rno']."'><button type='submit' value='1' name='status' class='btn btn-success'>Maintenance Done</button></form></td>";
                					echo "</tr>";}}}
                          ?>
                  </tbody>
                  </table>
