...
<a href="maintview.php"><i class="fa fa-wrench fa-fw"></i>Complaints View</a>                                   </li>
        ...
        <div id="page-wrapper">
            ...
            <div class="alert alert-warning" role="alert">
              ...
              $name=$_SESSION['name'];
                ...
                $query=mysqli_query($con,"select * from leaves where name='".$name."'");
  ...
  <div class='progress-bar progress-bar-success progress-bar-striped' role='progressbar' aria-valuenow='100' aria-valuemin='0' aria-valuemax='100' style='width: 100%'>
    <span style='color:black'>Permission Granted !</span></div></div>";
                  }
                  elseif ($rol==1) {
                  echo "<div class='progress'>
                    <div class='progress-bar progress-bar-info progress-bar-striped' role='progressbar' aria-valuenow='50' aria-valuemin='0' aria-valuemax='100' style='width: 50%'>
                        <span style='color:black'><h4>50% Complete (Approved By Councillor)</h4></span>
                    </div>
                  </div>";
                  }
                  elseif($rol==0)
                  ...
                  echo"<div class='progress'>
                    <div class='progress-bar progress-bar-warning progress-bar-striped' role='progressbar' aria-valuenow='25' aria-valuemin='0' aria-valuemax='100' style='width: 25%'>
                      <span style='color:black'>25% Complete (Submitted Successfully)</span>
                    </div>
                  </div>";
                  }
                }
                else {
                  echo"<div><h3>No Leave forms submitted ! </h3></div>";
                }
