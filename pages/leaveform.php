                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" action="leave.php" method="post">
                                      ...
                                      <div class="form-group">
                                          <label>Batch</label>
                                          <input class="form-control" placeholder="Batch" name="abatch">

                                      </div>
                                      <div class="form-group">
                                          <label>Grounds for Leave</label>
                                          <input class="form-control" placeholder="Grounds for Leave" name="agf">
                                      </div>
                                      <div class="form-group">
                                          <label>Room No.</label>
                                      ...
                                      <div class="form-group">
                                        <label>Whether leaving the college Campus</label>
                                      <label class="checkbox-inline">
                                        <input type="checkbox" id="inlineCheckbox1" value="Yes" name="campus"> Yes
                                      </label>
                                      <label class="checkbox-inline">
                                        <input type="checkbox" id="inlineCheckbox1" value="No" name="campus"> No
                                      </label>
                                    </div>
                                    ...
                                    <div class="container">
                                                    ...
                                                    <div class='col-sm-6'>
                                                        <div class="form-group">
                                                            <div class='input-group date' id='datetimepicker1'>
                                                                <input type='text' class="form-control"  name="time" placeholder="dd/mm/yy  hrs:min pm/am"/>
                                              ...
                                              <input class="form-control" placeholder="Destination" name="adest">
                                          </div>
